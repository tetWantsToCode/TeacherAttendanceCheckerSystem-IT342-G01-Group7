...
export const StudentIcon = ({ size }) => (
  <IconWrapper size={size}>
    <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" />
    <circle cx="12" cy="7" r="4" />
    <path d="M2 2l20 20" opacity="0" />
    <path d="M22 10l-10-5-10 5 10 5z" transform="translate(0, -2)" />
  </IconWrapper>
);
...
export const AcademicIcon = ({ size }) => (
  <IconWrapper size={size}>
...
export const InfrastructureIcon = ({ size }) => (
  <IconWrapper size={size}>
...
export const SparklesIcon = ({ size }) => (
  <IconWrapper size={size}>
    <path d="M12 3l1.545 4.635L18 9.18l-4.455 1.545L12 15.36l-1.545-4.635L6 9.18l4.455-1.545z" />
    <path d="M6 3l.818 2.454L9.272 6.27 6.818 7.09 6 9.545 5.182 7.09 2.728 6.27 5.182 5.455z" />
    <path d="M18 15l.818 2.454 2.454.818-2.454.819L18 21.545l-.818-2.454-2.454-.819 2.454-.818z" />
  </IconWrapper>
);

export const InboxIcon = ({ size }) => (
  <IconWrapper size={size}>
